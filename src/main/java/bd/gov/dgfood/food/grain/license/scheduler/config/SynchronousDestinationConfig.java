 ...
 */
package bd.gov.dgfood.food.grain.license.scheduler.config;
	...
	protected void activate(BundleContext bundleContext) {
		...
		DestinationConfiguration destinationConfiguration =
			new DestinationConfiguration(
				DestinationConfiguration.DESTINATION_TYPE_SYNCHRONOUS,LiferaySchedulerPortletKeys.DESTINATION_SYNCHRONOUS);
